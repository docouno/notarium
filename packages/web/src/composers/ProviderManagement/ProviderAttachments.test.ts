...
const listItem = (value: ProviderAttachmentView): ProviderAttachmentListItem => ({
  ...
  resource: {
    ...
    wire: value.resource.wire,
    owner: value.resource.owner,
    addressIsPrivate: value.resource.addressIsPrivate,
    purposes: value.resource.purposes,
    modelCount: value.resource.models.length,
    hasCredentials: value.resource.hasCredentials,
    disabledAt: value.resource.disabledAt,
  },
})
