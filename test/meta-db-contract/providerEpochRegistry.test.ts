  ...
  it('classifies every write as a route helper, system path, or retarget exception', () => {
    expect(mutators()).toEqual(
      [
        ...
        'packages/server/src/services/metaDb/drivers/pg/providerResources.ts:materializeModel',
        ...
        'packages/server/src/services/metaDb/drivers/sqlite/providerResources.ts:materializeModel',
